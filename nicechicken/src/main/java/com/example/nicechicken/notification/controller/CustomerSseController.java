...
import com.example.nicechicken.notification.service.CustomerSseEmitters;
...
public class CustomerSseController {
    ...
    private final CustomerSseEmitters customerSseEmitters;
    ...
    public ResponseEntity<SseEmitter> subscribe(@RequestParam("token") String token) {
        ...
        return ResponseEntity.ok(customerSseEmitters.add(email));
    }
}
